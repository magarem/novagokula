   ...
   <div class="text-light">
    <div v-for="i in Object.entries(schema)">
        ...
        <template v-if="i[1].type=='text[]+button'">
            ...
            <img v-if="data[i[0]][0]" :src="data[i[0]][0]" class="mb-3" style="width: 50px;"/>
            <div class="input-group mb-3">
                <button class="btn btn-outline-secondary" type="button" @click="clearInputBox(i[0][0])">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                    </svg>
                </button>
                <input
                    ...
                    v-model="data[i[0]][0]"
                />
                <button class="btn btn-outline-secondary" type="button" @click="$emit(i[1].buttonLink.link, i[0][0])">{{i[1].buttonLink.label}}</button>
            </div>

            <img v-if="data[i[0]][1]" :src="data[i[0]][1]" class="mb-3" style="width: 50px;"/>
            <div class="input-group mb-3">
                <button class="btn btn-outline-secondary" type="button" @click="clearInputBox(i[0][1])">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                    </svg>
                </button>
                <input
                    ...
                    v-model="data[i[0]][1]"
                />
                <button class="btn btn-outline-secondary" type="button" @click="$emit(i[1].buttonLink.link, i[0][1])">{{i[1].buttonLink.label}}</button>
            </div>
